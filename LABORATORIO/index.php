...
$sqlConsultas= "SELECT `prueba`.*, `tipo_prueba`.* FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba`";
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="INDEX.PHP" class="d-block"> <?php echo $_SESSION['usuario']; ?> </a>
        </div>
      </div>
...
<!--  ----------------formulario de busqueda   -->
                ...
                <table id="example1" class="table table-bordered table-info">
                  ...
                  if($mira==0){
                    ...
                    $mira="<span class='badge bg-success'>RESULTADO...</span>";
                  }
                  ...
                  ?>
                    ...
                    <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#consultaModaleditar"
                      data-bs-idpaciente="<?= $row_consultas['id_prueba'] ; ?>"><i class="fas fa-edit fa-pen-to-square"></i></a>
