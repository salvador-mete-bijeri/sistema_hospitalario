<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="consultaModalreseta" tabindex="-1" aria-labelledby="consultaModalresetaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="consultaModalresetaLabel">RECETAS</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="guardarreseta.php" method="post" enctype="multipart/form-data">
