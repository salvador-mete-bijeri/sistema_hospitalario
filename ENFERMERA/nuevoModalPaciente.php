<!-- Modal -->
<div class="modal fade" id="nuevoModalPaciente" tabindex="-1" aria-labelledby="nuevoModalPacienteLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nuevoModalPacienteLabel">REGISTRO PACIENTE</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="guardaPaciente.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="p-2 col-lg-5">
                        ...
                        <div class="p-2 col-lg-5">
                            <label for="fecha_nacimiento" class="form-label">FECHA DE NACIMEINTO</label>
