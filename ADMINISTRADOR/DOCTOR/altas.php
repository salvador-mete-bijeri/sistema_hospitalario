...
$sqlPacientes= "SELECT * FROM altas";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0">BIENVENIDO A ALTAS! </h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <a href="ingresos.php" class="btn btn-primary" > <i class="fas fa-plus"></i>  </a>
           </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-warning">
                  ...
                  <?php  while($row_ingresos = $pacientes->fetch_assoc()){  ?>

                    <tr>
                    <td> <?= $row_ingresos['id_alta']; ?></td>
                    <td> <?= $row_ingresos['id_ingreso']; ?></td>
                    <td> <?= $row_ingresos['dip']; ?></td>
                    <td> <?= $row_ingresos['fecha']; ?></td>
                    <td> <?= $row_ingresos['hora']; ?></td>
                    <td>
                      <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#altaModaleditar"
                      data-bs-idalta="<?= $row_ingresos['id_alta'] ;   ?>"><i class="fas fa-edit fa-pen-to-square"></i></a>
