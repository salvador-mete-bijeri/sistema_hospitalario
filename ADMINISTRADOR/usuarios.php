...
$sqlPacientes= "SELECT `usuarios`.`id_usuario`, `usuarios`.`nombre_usuario`, `usuarios`.`dip_personal`, `roles`.* FROM `usuarios` LEFT JOIN `roles` ON `usuarios`.`id_rol` = `roles`.`id_rol`;";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0">BIENVENIDO A USUARIOS! </h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <a href="../reportes/usuarios.php" class="btn btn-warning" target="_blank"> <i class="fa fa-print"></i> </a>
           </div>

          <div class="col-auto mt-2">
          <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModalusuario"> <i class="fas fa-user-plus"></i>  </a>
           </div>
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php  while($row_pacientes = $pacientes->fetch_assoc()){  ?>
                    ...
                    <td>
                      <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editarModalusuario"
                      data-bs-id_usuario="<?= $row_pacientes['id_usuario'] ;   ?>"><i class="fas fa-edit fa-pen-to-square"></i></a>

                      <a href="#" class="btn btn-sm btn-danger"  data-bs-toggle="modal" data-bs-target="#eliminaModalusuario"
                      data-bs-id_usuario="<?= $row_pacientes['id_usuario'] ;   ?>"><i class="far fa-trash-alt"></i></a>
                ...
                <?php include 'eliminaModalusuario.php'; ?>
...
<script>
  ...
  let editarModalusuario = document.getElementById('editarModalusuario')
    ...
    editarModalusuario.addEventListener('shown.bs.modal', event =>{
    let button = event.relatedTarget
    let id_usuario = button.getAttribute('data-bs-id_usuario')

    let inputDip = editarModalusuario.querySelector('.modal-body #dip_personal ')
    let inputNombreusuario = editarModalusuario.querySelector('.modal-body #nombre_usuario')
    let inputPassword = editarModalusuario.querySelector('.modal-body #password')
    let option = editarModalusuario.querySelector('.modal-body #rol')
    
  

    let url = "getusuariover.php"
    ...
    .then(data =>{
        ...
        inputPassword.value = data.password_usuario
        optionRol.value = data.nombre
