...
$sqlConsultas= "SELECT `prueba`.`id_prueba`,`prueba`.`dip`,`prueba`.`estado`, `tipo_prueba`.`nombre_prueba`,`prueba`.`resultado`, `prueba`.`fecha` FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba` where estado=1 ";
...
<span class="badge badge-danger navbar-badge"><i class="fas fa-user-lock"></i></span>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link">
      ...
      <span class="brand-text font-weight-light">LABORTORIO</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <h6 class="m-0">BIENVENIDO A LABORATORIO! </h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <!--  ----------------formulario de busqueda   -->
                 ...
                 <form action="../../reportes/laboratorio2.php" method="POST" target="_blank" >
...
<!--  ----------------formulario de busqueda   -->
                ...
                <table id="example1" class="table table-bordered table-warning">
                  ...
                  ?>
                    ...
                    <td>
                    <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#resultadosModalver"
                      data-bs-idpaciente="<?= $row_consultas['id_prueba'] ; ?>"><i class="fas fa-eye"></i></a>

                      <a href="../../reportes/laboratorio.php?id_prueba=<?= $row_consultas['id_prueba']; ?>" class="btn btn-sm btn-warning" target="_blank
                ...
                <?php include 'resultadosModalver.php'; ?>
...
<script>
    ...
    let resultadosModalver = document.getElementById('resultadosModalver')
    let consultaModalver = document.getElementById('consultaModalver')
    
    resultadosModalver.addEventListener('shown.bs.modal', event =>{
      let button = event.relatedTarget
    let id_prueba = button.getAttribute('data-bs-idpaciente')

    
    let inputIdPrueba = resultadosModalver.querySelector('.modal-body #id_prueba ')
    let inputDip = resultadosModalver.querySelector('.modal-body #dip')
    let inputPrueba = resultadosModalver.querySelector('.modal-body #nombre_prueba')
    let inputResultado = resultadosModalver.querySelector('.modal-body #resultado')
    ...
    .then(data =>{
      ...
      inputIdPrueba.value = data.id_prueba
        ...
        inputResultado.value=data.resultado
