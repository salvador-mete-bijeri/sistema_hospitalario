  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h6 class="m-0">BIENVENIDA ENFERMERA! </h6>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#nuevoModalPaciente"> <i class="fas fa-plus"></i>  </a>
           </div>
           ...
           <!-- fin de la alerta alerta -->
            ...
            <div class="card">
              <div class="card-body">
                  ...
                  <?php  while($row_pacientes = $pacientes->fetch_assoc()){  ?>
                    ...
                    <td>
                      ...
                      <div class="d-flex flex-row justify-content-center">
                        ...
                        <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#editaModalPaciente"
                      data-bs-idpaciente="<?= $row_pacientes['dip'] ;  ?>"><i class="fas fa-edit"></i></a>
                        ...
                        <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#eliminaModalPaciente"
                      data-bs-idpaciente="<?= $row_pacientes['dip'] ;  ?>">ELIMINAR</a>
                ...
                <?php include 'nuevoModalPaciente.php'; ?>

                <?php include 'editaModalPaciente.php'; ?>
                <?php include 'eliminaModalPaciente.php'; ?>
...
<script>
    ...
    let inputEdad = editaModalPaciente.querySelector('.modal-body #fecha_nacimiento')
    ...
    let inputSexo = editaModalPaciente.querySelector('.modal-body #genero')
    let inputEmail = editaModalPaciente.querySelector('.modal-body #email')
    let inputFecha = editaModalPaciente.querySelector('.modal-body #fecha_registro')
    ...
    .then(data =>{
        ...
        inputEdad.value = data.fecha_nacimiento
        inputTelefono.value = data.tel
     
        inputDireccion.value = data.direccion
        inputTutor.value = data.tutor
        inputSexo.value = data.genero
