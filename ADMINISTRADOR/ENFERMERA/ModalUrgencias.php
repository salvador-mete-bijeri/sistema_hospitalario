...
<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="ModalUrgencias" tabindex="-1" aria-labelledby="ModalUrgenciasLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalUrgenciasLabel">REGISTRO DE CONSULTAS URGENCIAS</h5>
