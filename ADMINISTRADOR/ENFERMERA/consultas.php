          ...
          <div class="row mb-2">
            ...
            <div class="row justify-content-end">
              ...
              <div class="col-auto mt-2">
                <a href="#" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#consultaModal"> <i class="fas fa-plus"></i> </a>
              </div>
...
<?php
                ...
                <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <?php while ($row_consultas = $consultas->fetch_assoc()) {  ?>
                        ...
                        <tr>
                          ...
                          <td> <?= $row_consultas['tension']; ?></td>
                          <td> <?= $row_consultas['hora']; ?></td>
                          <td> <?= $row_consultas['fecha']; ?></td>
                          <td> <?= $row_consultas['dip_personal']; ?></td>
                          <td>
                      ...
                      data-bs-id_consulta="<?= $row_consultas['id_consulta'] ;   ?>"><i class="fas fa-edit fa-pen-to-square"></i></a>
                            
                        </div>
                        <div class=" col-lg-3">

                        <a href="#" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#consultaModalver"
                      data-bs-id_consulta="<?= $row_consultas['id_consulta'] ;   ?>"><i class="far fa-eye"></i></a>
                           
                        </div>

                        <div class=" col-lg-3">

                        <a href="#" class="btn btn-sm btn-primary " data-bs-toggle="modal" data-bs-target="#ingresoModal"
                      data-bs-id_consulta="<?= $row_consultas['id_consulta'] ;   ?>"> INGRESAR</a>
                    ...
                    <div class=" col-lg-3">
                      ...
                      <a href="#" class="btn btn-sm btn-danger " data-bs-toggle="modal" data-bs-target="#eliminaModalConsulta"
                      data-bs-idpaciente="<?= $row_consultas['id_consulta'] ;  ?>">ELIMINAR</a>
                  ...
                  <?php include 'eliminaModalConsulta.php'; ?>
  ...
  <script>
    ...
    let  eliminaModalConsulta= document.getElementById('eliminaModalConsulta')
    ...
    let inputId_consulta = consultaModalver.querySelector('.modal-body #id_consulta')
    ...
    .then(data =>{
        ...
        eliminaModalConsulta.addEventListener('shown.bs.modal', event =>{
    let button = event.relatedTarget
    let id_consulta = button.getAttribute('data-bs-idpaciente')
    eliminaModalConsulta.querySelector('.modal-footer #id_consulta').value =id_consulta
    ...
    let inputTension = consultaModaleditar.querySelector('.modal-body #tension')
    ...
    .then(data =>{
        ...
        inputTemperatura.value = data.temperatura
        inputPresio_arterial.value = data.presion_arterial
        inputTension.value = data.tension
        inputFecha.value=data.fecha
        inputHora.value=data.hora
        inputMotivo.value=data.motivo
