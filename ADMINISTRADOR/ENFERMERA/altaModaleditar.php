<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="altaModaleditar" tabindex="-1" aria-labelledby="altaModaleditarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="altaModaleditarLabel">ESTAS VIENDO EL ALTA DE UN PACIENTE</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="actualizar_altas.php" method="post" enctype="multipart/form-data">


                    <div class="d-flex flex-row justify-content-center">

                    <input type="hidden" class="form-control" name="id_alta" id="id_alta" readonly>
                            

                        <div class="p-2 col-lg-5">
                        <label for="nombre" class="form-label">ID INGRESO</label>
                            <input type="text" class="form-control" name="id_ingreso" id="id_ingreso" readonly>
                            </div>
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        ...
                        <div class="p-2 col-lg-5">
                            ...
                            <input type="time" class="form-control" name="hora" id="hora" required  readonly>
                        </div>
