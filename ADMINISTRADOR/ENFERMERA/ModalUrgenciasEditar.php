...
<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="ModalUrgenciasEditar" tabindex="-1" aria-labelledby="ModalUrgenciasEditarLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalUrgenciasEditarLabel">EDITAR REGISTRO DE URGENCIAS</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="guardarUrgencias.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        <div class="p-2 col-lg-10">
                            ...
                            <textarea class="form-control" name="tratamiento" id="tratamiento"  placeholder="tratamiento" required></textarea>
                        </div>
                    </div>
