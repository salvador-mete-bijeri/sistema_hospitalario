...
<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="nuevoModalprueba" tabindex="-1" aria-labelledby="nuevoModalpruebaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="nuevoModalpruebaLabel">INSERTAR TIPO DE PRUEBA</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="guardar_prueba.php" method="post" enctype="multipart/form-data">
