    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalIngresosLabel">EDITANDO UN INGRESO</h5>
                ...
                <input type="txt" class="form-control" name="dip" id="dip"  readonly required>
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        <div class="p-2 col-lg-5">
                            ...
                            <input type="text" class="form-control" name="sala" id="sala" placeholder="sala" required>
                        </div>
                        <div class="p-2 col-lg-5">
                            <label for="numero_cama" class="form-label">CAMA</label>
                            <input type="text" class="form-control" name="numero_cama" id="numero_cama" placeholder="numero de cama" required>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="modal-footer col-auto">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="fas fa-sync
"></i></button>
