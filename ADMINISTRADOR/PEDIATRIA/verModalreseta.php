<!-- Modal -->
<div class="modal  modal-dialog-scrollable" id="verModalreseta" tabindex="-1" aria-labelledby="verModalresetaLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="verModalresetaLabel">ESTAS VIENDO UNA RECETA</h5>
                ...
                <form action="actualizarreceta.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="d-flex flex-row justify-content-center">
                        <div class="p-2 col-lg-5">
                            ...
                            <textarea class="form-control"  name="receta" id="receta" rows="10" cols="50" readonly></textarea>
                        </div>
                        <div class="p-2 col-lg-5">
                            <label for="instrucciones" class="form-label">INTRUCCIONES DE LA RECETA</label>
                            <textarea class="form-control"  name="instrucciones" id="instrucciones" rows="10" cols="50" readonly></textarea>
                        </div>
                    </div>
