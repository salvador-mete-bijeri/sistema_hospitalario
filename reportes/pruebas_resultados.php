...
$sql_filtro="SELECT `prueba`.`id_prueba`,`prueba`.`resultado`,`prueba`.`dip`, `tipo_prueba`.`nombre_prueba`, `tipo_prueba`.`precio`, `prueba`.`fecha` FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba` where estado=0 and dip=$dip_filtro and fecha='${fecha_filtro}'";
$resultado_filtro=mysqli_query($conn,$sql_filtro);


///=========

$sql_filtro1="SELECT `prueba`.`id_prueba`,`prueba`.`resultado`,`prueba`.`dip`, `tipo_prueba`.`nombre_prueba`, `tipo_prueba`.`precio`, `prueba`.`fecha` FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba` where  estado=0 and  dip=$dip_filtro and fecha='${fecha_filtro}'";
$resultado_filtro1=mysqli_query($conn,$sql_filtro1);


///====
$sql_filtro2="SELECT `prueba`.`id_prueba`,`prueba`.`resultado`,`prueba`.`dip`, `tipo_prueba`.`nombre_prueba`, `tipo_prueba`.`precio`, `prueba`.`fecha` FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba` where estado=0 and  dip=$dip_filtro and fecha='${fecha_filtro}'";
