...
$sql_consulta="SELECT * FROM consultas where dip=$dip_filtro and fecha='$fecha_filtro'";
...
$sql_prueba="SELECT `prueba`.*, `tipo_prueba`.* FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba` where dip=$dip_filtro and fecha='$fecha_filtro'";
$resultado_prueba=mysqli_query($conn,$sql_prueba);




$sql_receta="SELECT * FROM receta where dip=$dip_filtro and fecha='$fecha_filtro'";
$resultado_receta=mysqli_query($conn,$sql_receta);

$sql_ingreso="SELECT * FROM ingresos where estado=0 and dip=$dip_filtro and fecha='$fecha_filtro'";
$resultado_ingreso=mysqli_query($conn,$sql_ingreso);

$sql_alta="SELECT * FROM altas where  dip=$dip_filtro and fecha='$fecha_filtro'";
