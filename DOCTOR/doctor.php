                          ...
                          <td>
                            ...
                            <div class="d-flex flex-row justify-content-center">
                              <div class="p-2 col-lg-3">
                                ...
                                <a href="#" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#consultaModalver" data-bs-dip="<?= $row_consultas['dip'];   ?>">VER</a>
                              ...
                              <div class="p-2 col-lg-3">
                                ...
                                <a href="#" class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#consultaModalreseta" data-bs-id_consulta="<?= $row_consultas['id_consulta'];   ?>">RECETA</i></a>

                              </div>

                              <div class="p-2 col-lg-3">

                              <a href="#" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#ingresoModal" data-bs-id_consulta="<?= $row_consultas['id_consulta'];   ?>"> INGRESAR</a>
