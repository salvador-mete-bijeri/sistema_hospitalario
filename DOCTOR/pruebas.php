...
$sqlConsultas= "SELECT `prueba`.`id_prueba`,`prueba`.`dip`,`prueba`.`estado`, `tipo_prueba`.`nombre_prueba`,`prueba`.`resultado`, `prueba`.`fecha` FROM `prueba` LEFT JOIN `tipo_prueba` ON `prueba`.`id_tipo_prueba` = `tipo_prueba`.`id_tipo_prueba`";
...
<!--  ----------------formulario de busqueda   -->
                 ...
                 <form action="../reportes/todas_pruebas.php" method="POST"  target="_blank">
